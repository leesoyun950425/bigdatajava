        	...
        	<div class="col-lg-8 col-md-10 mx-auto">	
				<ul class="list-group list-group-flush">
					 <li class="list-group-item" style="padding-top: 9px; padding-bottom : 9px;">
							<table>
			 					<tr>
			 						<td id = "title" style="font: 17px 굴림; font-weight: bold;"><%= info2[0] %></td><!-- 제목 -->
					 ...
					 <li class="list-group-item" style="padding-top: 7px; padding-bottom : 7px;">
			 			<table>
			 				<tr>
			 					...
			 					<td id = "name" style="padding: 0px; font-size : 14px"><%= info2[1] %></td><!-- 작성자  -->
			 					...
			 					<td id = "time"style="font-size: 14px;"><%= info2[3] %></td><!-- 날짜 -->
			 				</tr>
			 			</table>
					 </li>
					 <li class="list-group-item">
					 	<table>
					 		<tr>
					 			<!-- 폰트적용부분 --><td id = "content"height = "250" style="font-size: '<%= fonts[1] %>'; font-family: '<%= fonts[0] %>';font-weight: '<%= fonts[2] %>'; text-align: '<%= fonts[3] %>';"><%= info2[2] %></td>
					 		</tr>
					 	</table>
					 </li>
				</ul>
				...
				<div id="commentDiv"style="background: gray; border: 2px; width: 800px; height: 200px; position: relative;">
					...
					<div id="commentDiv">
						...
						<input id="alComment" type="hidden" value="<%= info2[6] %>"><!-- 보여지지않는 댓글(,로 하나로 합침) -->
					</div>
				</div>
