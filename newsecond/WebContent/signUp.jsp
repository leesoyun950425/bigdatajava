...
<body>
	...
	<div id="signUp">
		...
		<div id="signUpForm" style="text-align: left;">
			<form method="get" action="signUp2.jsp">
				이름 : <input type="text" class="form-control input-sm"
					placeholder="Name" style="margin-bottom: 10px" name="name"> 
					비밀번호 : <input type="password" class="form-control input-sm" placeholder="Pw"
					style="margin-bottom: 10px" name="pw"> 
					나이 : <input type="text"
					class="form-control input-sm" placeholder="age"
					style="margin-bottom: 10px" name="age"> 
					성별 : <input type="radio"
					class="form-check-input-lg" name="gender" value="m" style="margin-left: 50px">남자
					<input type="radio" class="form-check-input-lg" name="gender" value="g"
					style="margin-left: 60px">여자 <br> <br> 
					전화번호 : <input type="text" class="form-control input-sm" placeholder="tel"
					style="margin-bottom: 10px" name="tel"> 
					
					주소 : <input type="text" class="form-control input-sm" placeholder="우편번호"
					 name = "sample6_postcode"  id="sample6_postcode"><br>
					 <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="btn btn-outline-success" 
					style="margin-bottom: 10px"><br>
					 <input type="text" class="form-control input-sm" 
					style="margin-bottom: 10px" name = "sample6_address" id="sample6_address" placeholder="주소"><br>
					 <input type="text" class="form-control input-sm" 
					style="margin-bottom: 10px" name = "sample6_detailAddress" id="sample6_detailAddress" placeholder="상세주소"><br>
					 <input type="text" class="form-control input-sm" 
					style="margin-bottom: 10px" name = "sample6_extraAddress" id="sample6_extraAddress" placeholder="참고항목"><br>
