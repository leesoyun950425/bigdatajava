...
<body>
	...
	<form action="memberDBChange.jsp">
		이름 : <input type="text" value="<%=infoArray[0]%>" readonly="readonly"
			id="name" name="name"> <br> 비밀번호 : <input type="text"
			value="<%=infoArray[1]%>" id="password" name="password"> <br>
		나이 : <input type="text" value="<%=infoArray[2]%>" id="age" name="age"><br>
		전화번호 : <input type="text" value="<%=infoArray[4]%>" id="tel"
			name="tel"> <br> 주소 : <input type="text"
			value="<%=infoArray[6]%>" id="addr" name="addr"><br> <input
